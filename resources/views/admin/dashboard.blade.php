...
<div class="space-y-6">
    <!-- Header -->
    <div>
        <h2 class="text-2xl font-bold leading-tight text-gray-900">Admin Dashboard</h2>
        <p class="mt-1 text-sm text-gray-600">Overview of your fleet management system</p>
    </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $stats['total_stations'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ $stats['total_trips'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow rounded-lg">
            <div class="p-5">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 truncate">Scheduled Trips</dt>
                            <dd class="text-lg font-medium text-gray-900">{{ $stats['total_scheduled_trips'] }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $booking->scheduledTrip->trip->name }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $booking->seat->seat_number }}</td>
